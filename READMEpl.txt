...
Ad ogni modo, l'input è organizzato nel seguente modo:
...
E' stato implementanto anche un diverso jsonread/2, il quale sfrutta anche jsonread/3, implementato come jsonread(Stream, Char, Chars), 
...
scrive su un file 'File'. Anch'esso, sfruttando jsondumpobj_/3, jsondumparray_/3 riconosce e organizza gli elementi in 'JSON' che verranno scritti su file con write/2 e printValue/2.
